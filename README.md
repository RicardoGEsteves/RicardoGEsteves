...
>
> Zustand | Tanstack/React Query | Tanstack/React-table | React Context API | React DOM | Payload CMS | OpenAI API | Replicate API | Axios | Stripe | Crisp | CSS Modules | Styled Components | Shadcn-UI | Storybook | Framer Motion | GSAP | Three.js | WebGL | Webhooks | JWT | OAuth |
