...
>
> Zustand | React Query | React Context API | React DOM | Payload CMS | OpenAI API | Replicate API | Axios | Stripe | Crisp | CSS Modules | Styled Components | Shadcn-UI | Storybook | Framer Motion | GSAP | Three.js | WebGL |
...
>
> Prisma | Zod | trpc | REST API | Livekit | Socket.io | Server Actions |
